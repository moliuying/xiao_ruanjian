...
<!--            {{text4}}-->
            <el-upload ref="upload" action="" :before-upload="export_excel_in1" :show-file-list="false" style="vertical-align: middle;display: inline-block; margin-left: 15px; margin-top: 10px;">
                <el-button  type="primary"   >导入文本1</el-button>
            </el-upload>
            ...
            <el-menu-item index="start" style="float: right;">
                <el-button type="warning" @click=" text1 = ''; text2 = ''; text3 = '';text4= '' ">清空</el-button>
            </el-menu-item>
        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            async trans(){
                if(!this.text1){
                    ElMessage({type: 'error', message: '文本1的内容不能为空'})
                    return
                }
                if(!this.text2){
                    ElMessage({type: 'error', message: '文本2的内容不能为空'})
                    return
                }
